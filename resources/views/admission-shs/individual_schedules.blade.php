    ...
    <table id='example1' class="table table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href='{{url('/admissionbed', array('view_individual_list', $schedule->id))}}'>View List</a></td>
                <td><a href="{{url('/admissionbed', array('edit_individual_schedule', $schedule->id))}}">Edit</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add New Individual Interview Schedule</h4>
            </div>
        
        <form method="post" action="{{url('admissionbed',array('add_individual_schedule'))}}">
