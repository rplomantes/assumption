...
<section class="content-header">
    <h1>
        BED Admission Testing Schedule
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><i class="fa fa-home"></i> Home</li>
        <li>Testing Schedule</li>
        <li class="active"><a href="{{url('admissionbed', array('edit_testing_schedule', $id))}}"> {{$id}}</a></li>
    </ol>
</section>
@endsection
@section('maincontent')
<div class="col-md-4">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Edit Testing Schedule</h3>
        ...
        <div class="box-body">
            <div class="col-sm-12">
                <form class="form-horizontal" method="post" action="{{url('admissionbed', array('edit_testing_schedule_now'))}}">
