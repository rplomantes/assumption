    ...
    <?php $school_year= \App\CtrEnrollmentSchoolYear::where('academic_type','BED')->first();?>
<h4>Student List Report</h4>
<h4>S.Y. {{$school_year->school_year}}</h4>
...
<table width='100%' cellpadding='0' cellspacing='0'>
    ...
    <?php $school_year = \App\CtrEnrollmentSchoolYear::where('academic_type', 'SHS')->first()->school_year;
    ...
    @else
    <?php $school_year = \App\CtrEnrollmentSchoolYear::where('academic_type', 'BED')->first()->school_year;
