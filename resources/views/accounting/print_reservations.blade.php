...
<div>
    ...
    <div style='float: left; margin-top:12px; margin-left: 10px' align='center'><span id="schoolname">Assumption College</span> <br><small> San Lorenzo Drive, San Lorenzo Village<br> Makati City</small><br><br><b>UNUSED RESERVATIONS</b></div>
</div>
<?php $counter = 1; ?>
<body>
    <div>
        <table width="100%" style="margin-top: 110px" border="1" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    <th width="5%">#</th>
