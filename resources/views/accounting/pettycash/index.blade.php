...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class='row'>
            <form action="{{ url('/print/pettycash') }}" method="post">
                {{csrf_field()}}
                <div class='col-md-4'>
                ...
                <div class='col-md-8'>
                    ...
                    <a type="button" class="btn btn-success" href="{{url("/pettycash/new")}}"><span class="fa fa-plus"></span><b> Create New</b></a>
                ...
                <table class="table table-condensed dataTable" id="example1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a type="button" href="{{url('/view/pettycash/'.$list->reference_id)}}"><b> View</b></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
$(document).ready(function () {
    ...
    $('#view').on('click', function () {
        ...
        $.ajax({
            type: "GET",
            url: "/pettycash/ajax/get_disbursements_note",
            data: array,
