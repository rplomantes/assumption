...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Student Deposits</li>
    </ol>
</section>
@endsection
@section('maincontent')
...
<script>
    ...
    function toPDF() {
        document.getElementById("myForm").action = "{{url('/accounting/print_deposits_pdf')}}";
    }

    function toEXCEL() {
        document.getElementById("myForm").action = "{{url('/accounting/print_deposits_excel')}}";
    }
    ...
    function generate_report(department, school_year, period) {
        ...
        $.ajax({
            type: "GET",
            url: "/accounting/ajax/get_deposits",
            data: array,
