                          ...
                          <td align='left' style='padding: 0 56px 28px 56px;' valign='top'>
                            <div style='font-family: "lato", "Helvetica Neue", Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333;'>
                                Thank you for pre-registering in Assumption College<br><br>
                                        This email is to notify you that your payment for Assumption College Testing Fee has been received.                                          
                                            <br><br>
                                                    You can now access your Student Portal Account in <a href='portal.assumption.edu.ph'><i>portal.assumption.edu.ph</i></a> to complete your application. Your credential is:<br><br>
                                                        <small>Username:&nbsp;<strong>{{$applicant_details->idno}}</strong><br>
                                                                Password:&nbsp;<strong>{{$applicant_details->idno}}</strong></small><br><br>
                                                                        
                                If you have questions kindly call Admission's Office(817-0757).
                                <!--Please call(817-0757 loc. 3020) or go to Admission's Office to get your Testing Schedule.-->
                                            </div>
                          </td>
                        </tr>
                        <tr>
