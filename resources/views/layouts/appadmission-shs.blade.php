...
$school_year = \App\CtrEnrollmentSchoolYear::where('academic_type','SHS')->first();
?>
...
<head>
  ...
  <title>Assumption College - Admission BED</title>
...
<div class="wrapper">
  <header class="main-header">
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-lg"><b>Admission</b>SHS</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{url('/admissionbed','individual_schedules')}}"><i class="fa fa-link"></i> Applicant Interview Schedules</a></li>
          </ul>
        </li>
<!--        <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('/bedadmission',array('reports','pre_registered',date('Y-m-d'),date('Y-m-d')))}}">Pre-Registered </a></li>
            <li><a href="{{url('/bedadmission',array('reports','for_approval',date('Y-m-d'),date('Y-m-d')))}}">For Approval </a></li>
