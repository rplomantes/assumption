...
<!--                                <li><a href="{{url('/registrar_college', array('curriculum_management','edit_schedule'))}}"><i class="fa fa-circle-o"></i> <span>*Edit Schedule</span></a></li>-->
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{url('/registrar_college', array('grade_management','incomplete_grades', $school_year, $period,'finals'))}}"><i class="fa fa-circle-o"></i> <span>INC/NG Grades</span></a></li>
