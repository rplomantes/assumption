...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Parent Interview Schedule</li>
        <li class="active"><a href="{{url('admissionbed', array('edit_interview_schedule', $id))}}"> {{$id}}</a></li>
    </ol>
</section>
@endsection
@section('maincontent')
<div class="col-md-4">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Edit Parent Interview Schedule</h3>
        ...
        <div class="box-body">
            <div class="col-sm-12">
                <form class="form-horizontal" method="post" action="{{url('admissionbed', array('edit_interview_schedule_now'))}}">
