...
<div>
    <table class='table' border="1" width="100%" cellspacing='0' cellpadding='0' style='margin-top: 145px;'>
        ...
        <tr>
            ...
            <td class='underline td' colspan='3'>{{$status->program_name}}</td>
        </tr>
        <tr>
    ...
    <table class='table' border="1" width="100%" cellspacing='0' cellpadding='0' style='margin-top: 12px;'>
        <thead>
            <tr style='background: #a0a0a0'>
                ...
                <th class='td'><b>Course Description</b></th>
                <th class='td'><b>Units</b></th>
                <th class='td'><b>Schedule</b></th>
                <th class='td'><b>Instructor</b></th>
            </tr>    
        </thead>
        <tbody>
