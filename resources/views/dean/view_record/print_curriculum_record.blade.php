...
<br><br><br><br><br><br><br><br>
        ...
        <tr>
            ...
            <td colspan='2'><div style="border-bottom: 1px solid black"><b>{{mb_strtoupper($user->lastname)}}, {{mb_strtoupper($user->firstname)}} {{strtoupper(mb_$user->middlename)}}&nbsp;</div></b></td>   
