                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse in">
                      <div class="box-body">
                          ...
                          <strong>Benefit Discount:</strong> <br>&nbsp;&nbsp;&nbsp;-100% Student Development Fee (2,500 for BED, 1,250 for SHS)<br>
                          *If with sibling
                          <br>&nbsp;&nbsp;&nbsp;-Php 150.00 Family Council Discount
                          <br><br>
                         <strong>Sibling Discount:</strong> <br>&nbsp;&nbsp;&nbsp;-50% Student Development Fee (1,250 for BED, 625 for SHS),
