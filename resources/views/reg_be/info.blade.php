            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab_5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type='checkbox' disabled="" name='psa' @if($bedrequirements->psa == 1)checked=''@endif><label>&nbsp;Original copy and two (2) clear photocopies of Philippine Statistics Authority (PSA) Birth Certificate</label>
                        </div>
                        @endif
                        @if($ctrrequirements->recommendation_form == 1)
                        <div class="col-sm-12">
                            <input type='checkbox' disabled="" name='recommedation_form' @if($bedrequirements->recommedation_form == 1)checked=''@endif><label>&nbsp;Recommendation Forms (duly accomplished by Guidance/ Class Adviser and Principal)</label>
                        </div>
                        @endif
                        @if($ctrrequirements->baptismal_certificate == 1)
                        <div class="col-sm-12">
                            <input type='checkbox' disabled="" name='baptismal_certificate' @if($bedrequirements->baptismal_certificate == 1)checked=''@endif><label>&nbsp;One (1) clear photocopy of Baptismal Certificate</label>
                        </div>
                        @endif
...
<!--                        @if($ctrrequirements->progress_report_card == 1)
                        ...
                        <div class="col-sm-12">
                            <input type='checkbox' disabled="" name='narrative_assessment_report' @if($bedrequirements->narrative_assessment_report == 1)checked=''@endif><label>&nbsp;Two (2) clear photocopies of either Certificate of Attendance or Narrative Assessment Report.</label>
                        </div>
                        @endif
                        <div class="col-sm-12"><hr><strong>For Foreign Students</strong><br>
                            <input type='checkbox' disabled="" name='acr' @if($bedrequirements->acr == 1)checked=''@endif><label>&nbsp;Alien Certificate of Registration (ACR)</label>
                        </div>
                        <div class="col-sm-12">
                            <input type='checkbox' disabled="" name='photocopy_passport' @if($bedrequirements->passport == 1)checked=''@endif><label>&nbsp;Photocopy of Passport</label>
                        </div>
                        <div class="col-sm-12">
                            <input type='checkbox' disabled="" name='visa_parent' @if($bedrequirements->visa_parent == 1)checked=''@endif><label>&nbsp;Visa/ Working Permit of Parents</label>
                        </div>
                        <div class="col-sm-12">
                            <input type='checkbox' disabled="" name='photocopy_of_dual' @if($bedrequirements->photocopy_of_dual == 1)checked=''@endif><label>&nbsp;Photocopy of dual citizenship passports (for dual citizenship)</label>
                        </div>
                    </div>
                </div>
            </div>
