 ...
 <div class="col-md-12">
     <div class='form-horizontal'>
        <div class='form-group'>
            ...
            <div class='col-sm-6'>
                <label>&nbsp;</label>
                <a href='/bedregistrar/enrollment_statistics_excel/{{$school_year}}'><button formtarget="_blank" type='submit' id='view-button' class='col-sm-12 btn btn-warning'>Download Excel</button></a>
            </div>
        </div>    
    </div>
     <div class="box">    
