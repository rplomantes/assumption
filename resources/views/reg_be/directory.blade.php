...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Student Directory</li>
      </ol>
</section>
@endsection
@section('maincontent')
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#level").on('change',function(e){
            if($("#level").val()=="Grade 11" || $("#level").val()=="Grade 12" ){
               ...
               $("#sectionDisplay").html("");
                ...
                $.ajax({
                    type:"GET",
                    url:"/bedregistrar/ajax/directory_getsection",
                    data:array,
       ...
       $("#view_list").on('click',function(e){
              ...
              $.ajax({
                  type:"GET",
                  url:"/bedregistrar/ajax/directory_view_list",
                  data:array,
                  success:function(data){
    ...
    function export_student_directory(){
        window.open("/bedregistrar/export/student_directory/" +$("#level").val() + "/" + $("#strand").val() + "/" + $("#section").val() + "/" + $("#school_year").val() + "/" + $("#period").val())
    }
</script>    
@endsection
