...
<section class="content-header">
      <h1>
        Conduct Grade Summary
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{url("/")}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Conduct Grade Summary</li>
      </ol>
</section>
@endsection
@section('maincontent')
...
<script>
    ...
    $(document).ready(function(){
       ...
       $("#view_list").on('click',function(e){
              ...
              $.ajax({
                  type:"GET",
                  url:"/bedregistrar/ajax/grade_summary_cond_view_list",
                  data:array,
                  success:function(data){
    ...
    function print_now(){
        window.open("/bedregistrar/print/cond_grade_summary/" +$("#level").val() + "/" + $("#strand").val() + "/" + $("#section").val() + "/" + $("#school_year").val() + "/" + $("#period").val())
    }
</script>    
@endsection
