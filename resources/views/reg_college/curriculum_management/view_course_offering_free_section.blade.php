...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url ('/registrar_college', array('curriculum_management','course_offering'))}}"> Free Section</a></li>
    </ol>
</section>
@endsection
@section('maincontent')
...
<script>
    function getList_fs(program_code){
    array = {};
    ...
    $.ajax({
    type: "GET",
            url: "/ajax/registrar_college/curriculum_management/view_offering_fs/" + program_code,
            data: array,
            success: function (data) {
            $('#course_to_offer').hide().html(data).fadeIn();
            }
    });
    getCourseOffered_fs(array, program_code);
    }

    function getCourseOffered_fs(array, program_code){
    ...
    $.ajax({
    type: "GET",
            url: "/ajax/registrar_college/curriculum_management/view_course_offered_fs/" + program_code,
            data: array,
            success: function (data) {
    ...
    function addtocourseoffering_fs(course_code) {
    array = {};
    array['curriculum_year'] = $("#curriculum_year").val();
    array['level'] = $("#year_level").val();
    array['period'] = $("#period").val();
    ...
    $.ajax({
    type: "GET",
            url: "/ajax/registrar_college/curriculum_management/add_to_course_offered_fs/" + course_code,
            data: array,
            success: function (data) {
    ...
    $.ajax({
    type: "GET",
            url: "/ajax/registrar_college/curriculum_management/remove_course_offered_fs/" + id,
            data: array,
            success: function (data) {
            $('#course_offered').html(data);
            }
    ...
    $.ajax({
    type: "GET",
            url: "/ajax/registrar_college/curriculum_management/add_offering_electives_fs/",
            data: array,
            success: function (data) {
            $('#course_offered').html(data);
            }
    ...
    $.ajax({
    type: "GET",
            url: "/ajax/registrar_college/curriculum_management/display_others/",
            data: array,
            success: function (data) {
