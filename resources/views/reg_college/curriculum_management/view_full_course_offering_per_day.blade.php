                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group course-form">
                                <label>Day</label>
                                <select id="day" class="form-control select2" style="width: 100%;">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button class="btn btn-success col-sm-12" onclick="get_offerings(school_year.value, period.value, day.value)">Search</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script>
    ...
    function get_offerings(school_year, period, day){
        array = {};
        ...
        $.ajax({
        type: "GET",
                url: "/ajax/registrar_college/curriculum_management/get_offerings_per_day/",
                data: array,
