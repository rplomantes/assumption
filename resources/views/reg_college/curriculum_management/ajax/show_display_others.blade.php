...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <button class="btn btn-success col-sm-12" onclick="getList_fs('{{$program_code}}')">Search</button>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group" id="submit_elective-form">
            <label>&nbsp;</label>
            <button class="btn btn-success col-sm-12" onclick="add_elective_fs(elective.value)">Add Elective</button>
        </div>
    </div>
</div>