...
?>
@if (count($students)>0)
<div class='col-sm-12'><div class='pull-right'><a target='_blank' href="{{url('registrar_college',array('print_grade_list', $school_year,$period,$schedule_id))}}"><button class='btn btn-primary'>Print Grade</button></a></div></div>
