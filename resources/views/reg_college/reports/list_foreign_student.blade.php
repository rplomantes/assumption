...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url ('/registrar_college', array('reports','list_foreign_student'))}}"></i> List Foreign Student</a></li>
    </ol>
</section>
@endsection
@section('maincontent')
        ...
        @endif
        <div class="row">
            <form class="form form-horizontal" method="post" action='{{url('/registrar_college/reports/print_foreign_student')}}'>
            {{ csrf_field() }}        
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header">  
                    <h3 class="box-title">Search Foreign Student</h3>
