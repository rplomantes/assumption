...
<div>   <?php $sy = \App\CtrGradeSchoolYear::where('academic_type', 'College')->first(); ?> 
    ...
    <div style='float: left; margin-top:12px; margin-left: 10px' align='center'><span id="schoolname">Assumption College</span> <br><small> San Lorenzo Drive, San Lorenzo Village<br> Makati City</small><br><br><b>CLASS LIST</b><br><b>A.Y. {{$school_year}} - {{$school_year + 1}}, {{$period}}</b></div><br>
</div>
<div>
...
$instructor = \App\User::where('idno', $instructor_id)->first();
?>
