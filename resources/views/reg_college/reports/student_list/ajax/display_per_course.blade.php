<div class="col-sm-12">
    <div class="box">
        ...
        <div class='box-header'>
            ...
            <a onclick='print_per_course(course.value,section.value ,school_year.value, period.value, level.value, academic_program.value)'><button class='btn btn-default pull-right'><span class='fa fa-print'></span> Print</button></a>
        </div>
        <div class="box-body">
            ...
            <table class='table table-hover table-striped table-condensed'>
                ...
                <tbody>
                    ...
                    <?php $status = \App\Status::where('idno', $list_per_course->idno)->where('status', 3)->first(); ?>
                    @if(count($status)>0)
