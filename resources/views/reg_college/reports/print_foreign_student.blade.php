...
<div>    
    ...
    <div style='float: left; margin-top:12px; margin-left: 10px' align='center'><span id="schoolname">Assumption College</span> <br><small> San Lorenzo Drive, San Lorenzo Village<br> Makati City</small><br><br><b>LIST OF FOREIGN STUDENT ENROLLED</b><br><b>A.Y. {{$request->school_year}} - {{$request->school_year + 1}}, {{$request->period}}</b></div>
</div>  
<div>
    ...
    <table class='table' border="1" width="100%" cellspacing='0' cellpadding='0' style='margin-top: 155px;'>
        ...
        <tbody>
            ...
            $info = \App\StudentInfo::where('idno', $student->idno)->first();?>
            <tr>
                <td >{{$count}}.</td>
                <td >{{$student->idno}}</td>
