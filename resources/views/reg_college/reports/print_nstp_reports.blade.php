    ...
    <table style='margin-top:150px' class='table' border="1" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align='center'><?php $count1 = \App\GradeCollege::join('college_levels', 'college_levels.idno','=','grade_colleges.idno')->where('college_levels.program_code', $program->program_code)->where('college_levels.status', '3')->where('grade_colleges.course_code', $request->course_code)->where('grade_colleges.level', "1st Year")->where('grade_colleges.school_year', $request->school_year)->where('grade_colleges.period', $request->period)->get(); ?>{{count($count1)}}</td></td>
                <td align='center'><?php $count2 = \App\GradeCollege::join('college_levels', 'college_levels.idno','=','grade_colleges.idno')->where('college_levels.program_code', $program->program_code)->where('college_levels.status', '3')->where('grade_colleges.course_code', $request->course_code)->where('grade_colleges.level', "2nd Year")->where('grade_colleges.school_year', $request->school_year)->where('grade_colleges.period', $request->period)->get(); ?>{{count($count2)}}</td>
                <td align='center'><?php $count3 = \App\GradeCollege::join('college_levels', 'college_levels.idno','=','grade_colleges.idno')->where('college_levels.program_code', $program->program_code)->where('college_levels.status', '3')->where('grade_colleges.course_code', $request->course_code)->where('grade_colleges.level', "3rd Year")->where('grade_colleges.school_year', $request->school_year)->where('grade_colleges.period', $request->period)->get(); ?>{{count($count3)}}</td>
                <td align='center'><?php $count4 = \App\GradeCollege::join('college_levels', 'college_levels.idno','=','grade_colleges.idno')->where('college_levels.program_code', $program->program_code)->where('college_levels.status', '3')->where('grade_colleges.course_code', $request->course_code)->where('grade_colleges.level', "4th Year")->where('grade_colleges.school_year', $request->school_year)->where('grade_colleges.period', $request->period)->get(); ?>{{count($count4)}}</td>
