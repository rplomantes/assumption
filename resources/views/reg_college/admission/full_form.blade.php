...
<!--siblings-->
                    <div id="siblings">
                        ...
                        <div class="form-group">
                            <div class="col-sm-1" >
                                <button id="addsiblings" class="btn btn-success" type="button">+</button>
                            </div>
                            
                                <div class="col-sm-3">
                                    <input class="form form-control" id="siblingname" name='siblingname' placeholder='Name/Level/Position' value="{{old('Name/Level/Position')}}" type="text">
                                </div>
                                <div class="col-sm-1">
                                    <input class="form form-control" id="siblingage" name='siblingage' placeholder='Age' value="{{old('siblingage')}}" type="text">
                                </div>  
                                <div class="col-sm-3">
                                    <input class="form form-control" id="schooloffice" name='schooloffice' placeholder='School/Office' value="{{old('schooloffice')}}" type="text">
                                </div>
                                <div class="col-sm-3">
                                    <input class="form form-control" id="gradeyear" name='gradeyear' placeholder="Grade/Year" value="{{old('gradeyear')}}" type="text">
                                </div>                                 
                        </div>
                    </div>
                        <div class="form-group">
...
$(document).ready(function(e){
    //variables
    //var addsibling = '<p /><div class="form-group"><div class="col-sm-1" ><button id="addsiblings" class="btn btn-success" type="button">+</button></div><div class="col-sm-3"><input class="form form-control" id="siblingname" name='siblingname' placeholder='Name/Level/Position' value="{{old('Name/Level/Position')}}" type="text"></div><div class="col-sm-1"><input class="form form-control" id="siblingage" name='siblingage' placeholder='Age' value="{{old('siblingage')}}" type="text"></div>  <div class="col-sm-3"><input class="form form-control" id="schooloffice" name='schooloffice' placeholder='School/Office' value="{{old('schooloffice')}}" type="text"></div><div class="col-sm-3"><input class="form form-control" id="gradeyear" name='gradeyear' placeholder="Grade/Year" value="{{old('gradeyear')}}" type="text"></div></div>';
    var addsibling = '<div class="col-sm-3"><input class="form form-control" id="siblingname" name='siblingname' placeholder='Name/Level/Position' value="{{old('Name/Level/Position')}}" type="text"></div>';
    //add rows
    $('#addsiblings').click(function(e){
        $('#siblings').append(addsibling);
    });
