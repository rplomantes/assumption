                            ...
                            <table align='center' border='0' cellpadding='0' cellspacing='0' style='border: 1px solid #E0E4E8;' width='100%'>
                                <tr>
                                    <td align='left' style='padding: 56px 56px 28px 56px;' valign='top'>
                                        <div style='font-family: "lato", "Helvetica Neue", Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333;font-weight:bold;'>Hello {{$user->firstname}}</div>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <div style='font-family: "lato", "Helvetica Neue", Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333 !important;'>                        
                                            <span style="color: #333">
                                                <p>
                                                    ...
                                                    You are now officially enrolled in Assumption College San Lorenzo. Your new ID Number will be <strong>{{$user->idno}}</strong>.
                                                    Use this ID Number to login to your student portal account with your current password.<br><br>
