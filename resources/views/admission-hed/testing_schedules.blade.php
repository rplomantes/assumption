    ...
    <table id='example1' class="table table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href='{{url('/admissionhed', array('view_testing_list', $schedule->id))}}'>View List</a></td>
                <td><a href="{{url('/admissionhed', array('edit_testing_schedule', $schedule->id))}}">Edit</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add New Testing Schedule</h4>
            </div>
        
        <form method="post" action="{{url('admissionhed',array('add_testing_schedule'))}}">
