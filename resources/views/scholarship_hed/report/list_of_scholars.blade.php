    ...
    <div class="col-md-12">
        <div class='form-horizontal'>
            <div class='form-group'>
                ...
                <div class='col-sm-4'>
                    <label>&nbsp;</label>
                    <button formtarget="_blank" type='submit' id='view-button' class='col-sm-12 btn btn-success' onclick="getList(scholarship.value, school_year.value, period.value)"><span>Get List</span></button>
                </div>
            </div>    
        </div>
    </div>
...
<script>
function getList(scholarship, school_year, period) {
    array = {};
    ...
    $.ajax({
    type: "GET",
            url: "/ajax/scholarship_college/report/get_scholarship_report/",
            data: array,
