...
//
    ...
    function print_now($school_year, $period, $exam_period,$idno) {
        if (Auth::user()->accesslevel == env("ACCTNG_STAFF") || Auth::user()->accesslevel==env("ACCTNG_HEAD")) {
            ...
            \App\Http\Controllers\Admin\Logs::log("Print exam permit for SY $school_year, $period, $exam_period of student number: $idno");
    ...
    function print_all(Request $request) {
        if (Auth::user()->accesslevel == env("ACCTNG_STAFF") || Auth::user()->accesslevel==env("ACCTNG_HEAD")) {
            ...
            \App\Http\Controllers\Admin\Logs::log("Print all exam permit of $school_year, $level, $period, $exam_period");
